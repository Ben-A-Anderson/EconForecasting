...
def prophet_scikit(alg, df, dtrain, dtest, dpred, predictors, target, datafolder ,filename, verbose=True):
    """
    prophet_scikit(alg, dtrain, dtest, dpred, predictors, target, IDcol, filename)
